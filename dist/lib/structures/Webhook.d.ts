...
export default class Webhook extends Base {
     ...
     */
    deleteMessage(messageID: string, options?: Types.Webhooks.DeleteWebhookMessageOptions, token?: string): Promise<void>;
    /**
     ...
     */
    edit(options: Types.Webhooks.EditWebhookOptions): Promise<Webhook>;
    /**
     ...
     */
    editMessage<T extends Types.Channels.AnyTextableGuildChannel = Types.Channels.AnyTextableGuildChannel>(messageID: string, options: Types.Webhooks.EditWebhookMessageOptions, token?: string): Promise<Message<T>>;
    /**
     * Edit a webhook via its token.
     * @param options The options for editing the webhook.
     * @param token The token for the webhook, if not already present.
     */
    editToken(options: Types.Webhooks.EditWebhookOptions, token?: string): Promise<Webhook>;
    /**
     * Execute the webhook.
     * @param options The options for executing the webhook.
     * @param token The token for the webhook, if not already present.
     */
    execute<T extends Types.Channels.AnyTextableGuildChannel>(options: Types.Webhooks.ExecuteWebhookWaitOptions, token?: string): Promise<Message<T>>;
    execute(options: Types.Webhooks.ExecuteWebhookOptions, token?: string): Promise<void>;
    /**
    ...
    executeGithub<T extends Types.Channels.AnyTextableGuildChannel>(options: Record<string, unknown> & {
        wait?: true;
    ...
    executeSlack<T extends Types.Channels.AnyTextableGuildChannel>(options: Record<string, unknown> & {
        wait?: true;
    }, token?: string): Promise<Message<T>>;
    /**
     ...
     * @param token The token for the webhook, if not already present.
     */
    getMessage<T extends Types.Channels.AnyTextableGuildChannel>(messageID: string, threadID?: string, token?: string): Promise<Message<T>>;
    /**
