...
export default class PrivateChannel extends Channel {
    ...
    protected update(data: Partial<Types.Channels.RawPrivateChannel>): void;
    /**
     * Create a message in this channel.
     * @param options The options for creating the message.
     */
    createMessage(options: Types.Channels.CreateMessageOptions): Promise<Message<this>>;
    /**
     ...
     */
    editMessage(messageID: string, options: Types.Channels.EditMessageOptions): Promise<Message<this>>;
    /**
     ...
     */
    getMessages(options?: Types.Channels.GetChannelMessagesOptions): Promise<Array<Message<this>>>;
    /**
    ...
    toJSON(): Types.JSON.JSONPrivateChannel;
    /**
