...
export default class ThreadChannel<T extends Types.Channels.AnyThreadChannel = Types.Channels.AnyThreadChannel> extends GuildChannel {
    ...
    protected update(data: Partial<Types.Channels.RawThreadChannel>): void;
    get parent(): Types.Channels.ThreadParentChannel | undefined;
    /**
     ...
     */
    createMessage(options: Types.Channels.CreateMessageOptions): Promise<Message<T>>;
    /**
     ...
     */
    editMessage(messageID: string, options: Types.Channels.EditMessageOptions): Promise<Message<T>>;
    /**
     * Get a thread member in this thread.
     * @param userID The ID of the user to get the thread member of.
     */
    getMember(userID: string): Promise<Types.Channels.ThreadMember>;
    /**
     * Get the members of this thread.
     */
    getMembers(): Promise<Array<Types.Channels.ThreadMember>>;
    /**
     ...
     */
    getMessages(options?: Types.Channels.GetChannelMessagesOptions): Promise<Array<Message<T>>>;
    /**
     ...
     */
    purge(options: Types.Channels.PurgeOptions<T>): Promise<number>;
    /**
    ...
    toJSON(): Types.JSON.JSONThreadChannel;
    /**
