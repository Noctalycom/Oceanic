...
export default class GroupChannel extends Channel {
    ...
    protected update(data: Partial<Types.Channels.RawGroupChannel>): void;
    /**
     * Add a user to this channel.
     * @param options The options for adding the user.
     */
    addRecipient(options: Types.Channels.AddGroupRecipientOptions): Promise<void>;
    /**
     * Edit this channel.
     * @param options The options for editing the channel.
     */
    edit(options: Types.Channels.EditGroupDMOptions): Promise<this>;
    /**
    ...
    toJSON(): Types.JSON.JSONGroupChannel;
}
