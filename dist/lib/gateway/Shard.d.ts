...
export default class Shard extends TypedEmitter<Types.Events.ShardEvents> {
     ...
     */
    requestGuildMembers(guildID: string, options?: Types.Gateway.RequestGuildMembersOptions): Promise<Array<Member>>;
    requestSoundboardSounds(guildID: string, options?: Types.Gateway.RequestSoundboardSoundsOptions): Promise<Array<Soundboard>>;
    reset(): void;
    resume(): void;
